...
%_defconfig:
	$(MAKE) $(MAKEARGS) $(DEFCONFIG) $@ && $(MAKE) $(MAKEARGS) $(DEFCONFIG) savedefconfig
...
$(config_change_targets): $(DEFCONFIG_FILE)
	$(MAKE) $(MAKEARGS) $(DEFCONFIG) defconfig $@ && $(MAKE) $(MAKEARGS) $(DEFCONFIG) savedefconfig
...
define UPDATE_DEFCONFIG
	echo 'BR2_DL_DIR="$$(BR2_EXTERNAL_$(PROJECT_NAME)_PATH)/dl"' >> $(DEFCONFIG_FILE)
	echo 'BR2_PACKAGE_OVERRIDE_FILE="$$(BR2_EXTERNAL_$(PROJECT_NAME)_PATH)/local.mk"' >> $(DEFCONFIG_FILE)
