...
CONFIG.PHASE {0.000} \
  ...
  set HIGH [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant HIGH ]
...
CONFIG.c_sg_use_stsapp_length {1} \
  ...
  set axi_ethernet_0_gtxclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz axi_ethernet_0_gtxclk ]
  set_property -dict [ list \
...
CONFIG.MMCM_COMPENSATION.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: axi_interconnect_periph, and set properties
  set axi_interconnect_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect axi_interconnect_periph ]
  set_property -dict [ list \
CONFIG.NUM_MI {6} \
...
CONFIG.NUM_PORTS {6} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect_periph/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_periph/M01_AXI] [get_bd_intf_pins axi_timer_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_periph_M02_AXI [get_bd_intf_pins axi_interconnect_periph/M02_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_periph_M03_AXI [get_bd_intf_pins axi_interconnect_periph/M03_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_periph_M04_AXI [get_bd_intf_pins axi_ethernet_0/s_axi] [get_bd_intf_pins axi_interconnect_periph/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_periph_M05_AXI [get_bd_intf_pins axi_ethernet_0_dma/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DP [get_bd_intf_pins axi_interconnect_periph/S00_AXI] [get_bd_intf_pins microblaze_0/M_AXI_DP]
  ...
  # Create port connections
  connect_bd_net -net HIGH_dout [get_bd_pins HIGH/dout] [get_bd_pins mig_7series_0/sys_rst]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_ethernet_0/ref_clk] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_7series_0/ui_addn_clk_0]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_0_dma/m_axi_mm2s_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_s2mm_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0_dma/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0_gtxclk/clk_in1] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_periph/ACLK] [get_bd_pins axi_interconnect_periph/M00_ACLK] [get_bd_pins axi_interconnect_periph/M01_ACLK] [get_bd_pins axi_interconnect_periph/M02_ACLK] [get_bd_pins axi_interconnect_periph/M03_ACLK] [get_bd_pins axi_interconnect_periph/M04_ACLK] [get_bd_pins axi_interconnect_periph/M05_ACLK] [get_bd_pins axi_interconnect_periph/S00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_mig_7series_0_100M/aux_reset_in]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_interconnect_aresetn [get_bd_pins axi_interconnect_periph/ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins rst_mig_7series_0_100M/interconnect_aresetn]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0_dma/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_periph/M00_ARESETN] [get_bd_pins axi_interconnect_periph/M01_ARESETN] [get_bd_pins axi_interconnect_periph/M02_ARESETN] [get_bd_pins axi_interconnect_periph/M03_ARESETN] [get_bd_pins axi_interconnect_periph/M04_ARESETN] [get_bd_pins axi_interconnect_periph/M05_ARESETN] [get_bd_pins axi_interconnect_periph/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
